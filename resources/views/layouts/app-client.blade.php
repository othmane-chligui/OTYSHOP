  ...
  <body>
                        <header class="blog-header bg-dark lh-1 py-3">
                            ...
                            <div class="col-4 text-center">
                                <a class="blog-header-logo text-light fst-italic" href="#" style="text-decoration:none">OTYSHOP</a>
                            </div>
                            @guest
                            <div class="col-4 d-flex justify-content-end align-items-center" >
                                <a class="btn btn-sm btn-outline-secondary text-light" href="{{ route('login') }}">Connecter</a>
                            </div>
                            @else
                            <div class="col-4 d-flex justify-content-end align-items-center">
